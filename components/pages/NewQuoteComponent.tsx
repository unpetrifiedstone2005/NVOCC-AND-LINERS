...
interface FormData {
  startLocation: string; // UN/LOCODE (or fallback text)
  endLocation: string;   // UN/LOCODE (or fallback text)
...
const offers: Offer[] = [
  {
    ...
    features: ["Door-to-Door", "Real-time Tracking, Priority Loading".replace(",", " •")],
  },
  {
    id: 2,
    carrier: "MSC",
...
export const NewQuoteComponent: React.FC = () => {
  // Steps are now: 1) SEARCH, 2) OFFER SELECTION, 3) REVIEW
  ...
  // Human-friendly labels for display (inputs store codes in formData)
  ...
  return (
    <div className="max-w-[1600.24px] mx-auto px-4 flex flex-col font-bold rounded-xl p-10">
      <div>
                  ...
                  <div className="bg-[#df992f] border border-[#444] rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-[#1c1c1c] text-md ">
                        ...
                        <p className="mb-2">
                          Please provide the most restrictive UN number of your planned cargo. Dangerous Goods IMO Classes 1, 6.2 and 7, Military
                          Cargo and Waste Shipments (Amber Listed under the Basel Convention and used / waste Batteries) are excluded from the web
                          quotation.
                        </p>
                      </div>
                    </div>
        ...
        {currentStep === 2 && (
          <div
            className={`${sectionStyle} p-13 mb-13`}
            style={{
              backgroundImage: `
                linear-gradient(to bottom left, #0A1A2F 0%, #0A1A2F 15%, #22D3EE 100%),
                linear-gradient(to bottom right, #0A1A2F 0%, #0A1A2F 15%, #22D3EE 100%)
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              {[
                ...
                <button
                  ...
                  className={clsx(
                    "p-2 text-md font-bold transition shadow border-2 border-black cursor-pointer",
                      ...
                      <div>
                        ...
                        <div className="bg-[#1A2A4A] rounded-xl border-4 border-black p-6 mb-6">
                          <p className="text-[#faf9f6] mb-4">
                            Future Marine Fuel Recovery (MFR) surcharge adjustments may not be considered in above offer. You can find all global
                            MFR values and validity at{" "}
                            <span className="text-[#00FFFF] underline cursor-pointer">Marine Fuel Recovery Surcharge (MFR)</span>.
                          </p>
                          <p className="text-[#faf9f6]">
                            To get more information check{" "}
                            <span className="text-[#00FFFF] underline cursor-pointer">Quick Quotes Terms and Conditions</span>.
                          </p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          {["FAK Definition", "Local Charges", "Detention & Demurrage", "Country Specific Remarks"].map((link) => (
                            <div
                              key={link}
                              className="bg-[#0A1A2F] rounded-xl shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:shadow-[10px_8px_0px_rgba(0,0,0,1)] border-4 border-black p-3 text-white font-bold hover:bg-[#2D4D8B] cursor-pointer transition-all"
                            >
                              {link}
                            </div>
                          ))}
        ...
        {currentStep === 3 &&
          (() => {
            const base = selectedOffer ? moneyToNumber(selectedOffer.price) : 0;
                    ...
                    <div className="border-l border-[#00FFFF] pl-6 flex items-center gap-6">
                      <div className="text-center">
                        ...
                        <div className="uppercase text-[#00FFFF] text-sm font-bold">
                          {formData.containerQuantity}× {formData.containerType}
                        </div>
                      </div>
                      <div className="text-center">
                      ...
                      <div className="text-center">
                        ...
                        <div className="uppercase text-[#00FFFF] text-sm font-bold">
                          {selectedOffer ? selectedOffer.transitTime : "-"}
                        </div>
                      </div>
                      <div className="text-center">
